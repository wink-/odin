...
<div class="row">
        <div class="span12">
            <ul class="nav nav-pills" id="myTabs">
              <li class="active"><a id="tab-1" href="#one" data-toggle="tab">Electroless Nickel</a></li>
              <li><a href="#two" id="tab-2" data-toggle="tab">Cleaners</a></li>
              <li><a href="#three" id="tab-3" data-toggle="tab">Zincs</a></li>
              <li><a href="#four" id="tab-4" data-toggle="tab">Anodize</a></li>
              <li><a href="#five" id="tab-5" data-toggle="tab">Chrome</a></li>
              <li><a href="#six" id="tab-6" data-toggle="tab">Tin</a></li>
              <li><a href="#seven" id="tab-7" data-toggle="tab">Cadmium</a></li>
              <li><a href="#eight" id="tab-8" data-toggle="tab">Chem Film</a></li>
